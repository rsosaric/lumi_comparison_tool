...
# NLS default array
# nls_default_array = (1, 5, 15, 25, 50, 70, 100, 150)
nls_default_array = (1, 5, 15, 25, 50)

class ByNlsTest:

    __hist_name = 'nls_ratio_hist_lw'

    def __init__(self, det1: L, det2: L, nls_array=nls_default_array, array_by_step=None) -> None:
